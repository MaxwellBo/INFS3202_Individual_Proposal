...
\begin{itemize}
    \item \texttt{GET /token -> Ok[FriendToken]}
    \item \texttt{POST /add\_friend?token=<FriendToken> -> Ok[Empty]}
    \item \texttt{GET /friends -> Ok[List[UserID]]}
    \item \texttt{GET /friends/:userid -> Ok[FriendDetails]}
    \item \texttt{GET /friend\_breaks?friendid=<friendID> -> Ok[List[Break]]}
    \item \texttt{POST /create\_group -> Created[GroupID]}
    \item \texttt{GET /groups -> Ok[List[GroupID]]}
    \item \texttt{GET /groups/:groupid -> Ok[GroupDetails]}
